    ...
    <section className='py-14 bg-neutral-950 text-white'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4'>
          {visible.map(b=> (
            <article key={b.id} className='group rounded-2xl overflow-hidden bg-white/5 ring-1 ring-white/10 hover:ring-white/30 transition'>
              <div className='p-4'>
                ...
                <div className='mt-4 flex gap-2'>
                  <button onClick={()=> navigate(`/brands/${b.brand}`)} className='flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-orange-500 to-rose-600 text-white text-sm font-medium'>Explore</button>
