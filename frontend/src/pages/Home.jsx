    ...
    <div className="space-y-8 pb-8">
      ...
      <section>
        <SectionHeader
          ...
          subtitle="Main bike cards are prioritized. Snapshot and event modules are moved below."
        />
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <article className="rounded-3xl border border-slate-200/10 bg-gradient-to-br from-slate-900/80 via-cyan-950/20 to-orange-950/20 p-4 md:col-span-2 xl:col-span-1">
